...
class TableSerializable(object, metaclass=abc.ABCMeta):
    ...
    in rds model instance so that it can be serialized to CSV file.
    ...
    def create_next_record(self) -> Union[RDSModel, None]:
        ...
        The process that consumes this class takes the output serializes
        to the desired relational database.
